...
(check-expect (render (make-editor "a" "bc"))
              (overlay/align "left"
                             ...
                             MTS))
(check-expect (render (make-editor "df" "zz"))
              (overlay/align "left"
                             "middle"
                             (beside (text "df" TEXT-SIZE TEXT-COLOR)
                                     CURSOR
                                     (text "zz" TEXT-SIZE TEXT-COLOR))
                             MTS))
...
(check-expect (cursor-right (make-editor "ab" "bde")) (make-editor "abb" "de"))
...
;; !!!
(check-expect (insert (make-editor "hello" "") "a") (make-editor "helloa" ""))
(check-expect (insert (make-editor "he" "llo") "b") (make-editor "heb" "llo"))
(check-expect (insert (make-editor "" "hello") "a") (make-editor "a" "hello"))
