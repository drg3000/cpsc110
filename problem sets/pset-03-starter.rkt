...
;; place BALL on MTS at appropriate x, y coordinate
;; !!!

(check-expect (render-ball B1) (place-image BALL (/ WIDTH 2)(/ HEIGHT 2) MTS))
(check-expect (render-ball (make-ball (- WIDTH 1) (- HEIGHT 1) 10 10))
              (place-image BALL (- WIDTH 1) (- HEIGHT 1) MTS))
...
(check-expect (touch-bottom? (make-ball LEF (- BOT 5) 3 5)) true)
(check-expect (touch-bottom? (make-ball LEF (- BOT 4) 3 3)) false)
...
(check-expect (touch-left? (make-ball (+ LEF 5) (/ HEIGHT 2) -5 3)) true)
(check-expect (touch-left? (make-ball (+ LEF 1) (/ HEIGHT 2) -2 3)) true)
(check-expect (touch-left? (make-ball (+ LEF 10) (/ HEIGHT 2) -9 3)) false)
(check-expect (touch-left? (make-ball (+ LEF 4) (/ HEIGHT 2) 3 3)) false)
...
(check-expect (touch-right? (make-ball (- RIG 5) 250 5 3)) true)
(check-expect (touch-right? (make-ball (- RIG 6) 250 5 3)) false)
(check-expect (touch-right? (make-ball (- RIG 4) 250 8 3)) true)
(check-expect (touch-right? (make-ball (- RIG 0) 250 -10 3)) false)
...
(check-expect (bounce-bottom (make-ball LEF (- BOT 0) 3 3))
              (make-ball LEF (- BOT 1) 3 -3))
...
(define (bounce-bottom b)
  (make-ball (ball-x b) (- BOT 1) (ball-dx b) (* (ball-dy b) -1)))
...
(check-expect (bounce-left (make-ball (+ LEF 5) 205 -6 3))
              (make-ball (+ LEF 1) 205 6 3))

(check-expect (bounce-left (make-ball (+ LEF 10) 205 -11 3))
              (make-ball (+ LEF 1) 205 11 3))
...
(define (bounce-left b)
  (make-ball (+ 1 LEF) (ball-y b) (* (ball-dx b) -1) (ball-dy b)))
...
(check-expect (bounce-right (make-ball (- RIG 6) 250 6 3))
              (make-ball (- RIG 1) 250 -6 3))
(check-expect (bounce-right (make-ball (- RIG 10) 250 11 3))
              (make-ball (- RIG 1) 250 -11 3))
(check-expect (bounce-right (make-ball (- RIG 9) 250 11 3))
              (make-ball (- RIG 1) 250 -11 3))
...
(define (bounce-right b)
  (make-ball (- RIG 1) (ball-y b) (* (ball-dx b) -1) (ball-dy b)))
...
;about to hit top edge
(check-expect (glide (make-ball (/ WIDTH 2) (+ TOP 5) 3 -4))
              (make-ball (+ (/ WIDTH 2) 3) (+ TOP 5 -4) 3 -4))
;about to hit bottom edge
(check-expect (glide (make-ball (/ WIDTH 2) (- BOT 5) 3 4))
              (make-ball (+ (/ WIDTH 2) 3) (+ (- BOT 5) 4) 3 4))
;about to hit left edge
(check-expect (glide (make-ball (+ LEF 5) (/ HEIGHT 2) -4 3))
              (make-ball (+ LEF 5 -4) (+ (/ HEIGHT 2) 3) -4 3))
;about to hit right edge
(check-expect (glide (make-ball (- RIG 5) (/ HEIGHT 2) 4 3))
              (make-ball (+ (- RIG 5) 4) (+ (/ HEIGHT 2) 3) 4 3))
