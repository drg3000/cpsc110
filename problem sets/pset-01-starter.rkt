...
;; takes two images, returns image with largest height

;(define (taller-image i1 i2) empty-image);stub


(check-expect (taller-image (rectangle 1 4 "solid" "blue")
                            (rectangle 1 3 "solid" "blue"))
              (rectangle 1 4 "solid" "blue"))

(check-expect (taller-image (rectangle 1 3 "solid" "blue")
                            (rectangle 1 5 "solid" "blue"))
              (rectangle 1 5 "solid" "blue"))

(check-expect (taller-image (rectangle 5 10 "solid" "blue")
                            (rectangle 5 10 "solid" "blue"))
              "No taller image, i1 i2 same height")
...
(define (taller-image i1 i2)
  (if (> (image-height i1) (image-height i2))
      i1
      (if (> (image-height i2) (image-height i1))
          i2
          "No taller image, i1 i2 same height")))

(taller-image (rectangle 45 80 "solid" "yellow")
              (rectangle 45 45 "solid" "green"))
(taller-image (square 10 "solid" "yellow")
